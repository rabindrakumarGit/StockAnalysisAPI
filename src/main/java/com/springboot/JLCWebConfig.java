...
return new ApiInfo( "Bank API" , "Bank API - part of  Application",
"1.9","Free to use for 10 times",
new springfox.documentation.service.Contact("rab","https://www.xyz.com","sd@xyz.com"),
"API Under Free Licence","https://www.xyz.com" );
}
@Bean
public Docket api() {
